...
2. We have modified the parameters; the modified parameters are as follows: 
        ...
        feet_clearance_reward_scale: -3.0  Significantly reduce the penalty for the height of leg lifting to prevent robots from performing extremely conservative and strenuous "high leg lifting" actions to avoid punishment, thereby saving energy.
